...
?>
    ...
    <p><?php $dateformat = date_create()->format('Y-m-d'); echo $dateformat; ?></p>
    <hr>
        <p><a class="btn btn-lg btn-primary" href="../index.php" role="button">Let's Start Invoicing</a></p>
            <p><a class="btn btn-lg btn-default" href="myaccount.php" role="button">Set New Password Now</a></p>
